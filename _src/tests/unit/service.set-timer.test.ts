...
describe('setTimer function', () => {
  ...
  it('should resolve with an error message when the timer expires', async () => {
    // Mock ToadScheduler and related functions
    ...
    expect(mockAddJob).toHaveBeenCalledWith(expect.any(Object), expect.any(Function)); // Ensure addSimpleIntervalJob was called
  });
});
